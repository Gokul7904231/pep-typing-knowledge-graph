...
pythondef compile(source: str, filename, mode='eval') -> Code: ...
...
6. PEP 544 — Protocols: Structural subtyping (static duck typing) (reading notes)
...
7. PEP 585 — Type Hinting Generics In Standard Collections (reading notes)
...
8. PEP 604 — Allow writing union types as X | Y (reading notes)
